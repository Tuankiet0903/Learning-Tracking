...
//         
//            out.println("<h1>Servlet LoginConTroller at " + mail + "</h1>");
//            out.println("<h1>Servlet LoginConTroller at " + password + "</h1>");
//            out.println("<h1>Servlet LoginConTroller at " + rePass + "</h1>");
//            out.println("<h1>Servlet LoginConTroller at " +  email+ "</h1>");
//        }
    }
